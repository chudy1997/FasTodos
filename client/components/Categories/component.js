...
export default class CategoriesComponent extends Component {
  ...
  createCategories = () => {
    ...
    return this.props.categories.map(category =>
        <li style={{backgroundColor:this.props.colorMap[category.categoryId%Object.keys(this.props.colorMap).length]}}
            key={(id++)} id={id} className={this.props.chosenCategoryId == id ? 'category chosen-category': 'category'} onClick={this.chooseCategory} >
